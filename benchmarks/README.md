...
`load_developer_memory_seed.py` creates a local Yena SQLite database from the seed file. It applies the project migrations, inserts evidence, agent scopes, redaction policy, memory versions, metadata, compiled observations, links, and retrieval FTS documents.
